  ...
  <body>
    <div class="wrapper">
      ...
      <div class="container">
        ...
        <div class="contants">
          <div class="tit-wrap">
            <h1>게시판 상세 - 기관 공지사항(BBS00000001)</h1>
          </div>
					...
					<table border="1" style="border-top-color: black; border-top-width: 3px; margin-top: 0px;">
						...
						<tbody>
							<tr>
								...
								<td class="instInfo" style="text-align: left; padding-left: 25px;">기관 공지사항</td>
								<th class="instInfoTitle">게시판 유형 <span style="color:red;">*</span></th>
								<td class="instInfo" style="text-align: left; padding-left: 25px;">공지형</td>
							</tr>
							<tr>
								<th class="instInfoTitle">게시판 설명</th>
								<td class="instInfo" colspan="3" style="text-align: left; padding-left: 25px;">기관전용 알림 공지사항 게시판 입니다.</td>
							</tr>
							<tr>
								...
								<td class="instInfo"  style="text-align: left; padding-left: 25px;">
									<button type="button" class="btns" style="background-color: white; color: black; ">관리</button>
								</td>
							</tr>
							<tr>
