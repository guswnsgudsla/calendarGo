			...
			<div class="contants">
				...
				<div class="control-wrap"  >
							<div class="search fm-ele" style="width:60%;">
								<span style="width:10%; padding-top: 10px;">권한 명 :</span><input type="text" placeholder="권한 명을 입력하세요.">
								
							</div>
							<div class="fm-ele" style="width:60%; margin-left: 25px;">
							<span style="margin-right: 7px;">권한 유형 : </span>
				...
				<div style="margin-top: 20px; text-align: right;" >
					...
					<button type="button" class="btns" id="" onclick="">등록</button>
				</div>
				...
				<table class="list">
					...
					<tbody>
						<tr>
							...
							<td>사용</td>
							<td>
								<button type="button" class="btns" style="padding: 0; background-color: green;">이력보기</button>
							</td>
							<td>
								2023/09/19
							</td>
