			...
			<div class="contants">
				...
				<div style="margin-top: 20px; margin-bottom:20px; text-align: right;" >
					<div style="float:left; font-size: 3.2rem; font-weight: 700; color: #000;">
						<h1>기관관리자 권한그룹 매핑 메뉴 상세 보기</h1>
					</div>
					<div style="float:right; margin-bottom:20px;" >
						<button type="button" class="btns" id="" onclick="">이력 조회</button>
						<button type="button" class="btns" id="" onclick="">수정</button>
						<button type="button" class="btns" id="" onclick="">삭제</button>
