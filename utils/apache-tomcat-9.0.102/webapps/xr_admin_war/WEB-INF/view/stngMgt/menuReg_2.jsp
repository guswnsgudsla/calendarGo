		...
		<div class="container">
			...
			<div class="contants">
				...
				<div class="btn-wrap align-right" >
					...
					<button type="button" class="btns">저장</button>
				</div>
				<div style="float: left; width: 30%;">
					...
					<div class="control-wrap">
						...
						<button id="bigMenuPlus" onclick="bigMenuPlus();">&nbsp;+&nbsp;</button>
						<button id="removeBigMenu" onclick="removeBigMenu();">&nbsp;-&nbsp;</button>
						<button id="refresh" onclick="refresh();">초기화</button>
						</div>
						  <li>
						    <a href="#subMenu1" class="open">- 가가가</a>
						    <ul id="subMenu1" style="margin-top: 10px;">
						    <button id="subMenu1Plus" onclick="subMenuPlus1();">&nbsp;+&nbsp;</button>
						    <button id="removeSubMenu" onclick="removeSubMenu1();">&nbsp;-&nbsp;</button>
						  ...
						  <li>
						    ...
						    <button id="subMenu2Plus" onclick="subMenuPlus2();">&nbsp;+&nbsp;</button>
						    <button id="removeSubMenu" onclick="removeSubMenu2();">&nbsp;-&nbsp;</button>
						  ...
						  <li>
						    ...
						    <button id="subMenu3Plus" onclick="subMenuPlus3();">&nbsp;+&nbsp;</button>
						    <button id="removeSubMenu" onclick="removeSubMenu3();">&nbsp;-&nbsp;</button>
				...
				<div style="float: left; width: 60%; margin-left: 80px;">
					...
					<div class="control-wrap">
						<div class="search fm-ele" >
							<span>메뉴 명 : 추가 메뉴</span>
						</div>
						<div class="search fm-ele">
							<span style="width: 15%; padding-top: 10px;">메뉴 상세 :</span><input type="text">
						</div>
						<div class="search fm-ele" style="justify-content: start;">
							<span style="width: 20%; padding-top: 2px;">메뉴 사용 여부 :</span>
							<span class="select">
								<input type="radio" id="select" name="useYN" value="Y" checked="checked"><label for="select">사용</label>
	     						<input type="radio" id="select2" name="useYN" value="N"><label for="select2">미사용</label>
     						</span>
						</div>
						<div class="search fm-ele">
							<span style="width: 20%; padding-top: 10px;">연결 화면 명 :</span><input type="text">
						</div>
						<div class="search fm-ele">
							<span style="width: 20%; padding-top: 10px;">연결 화면 URI :</span><input type="text">
						</div>
						<div class="search fm-ele">
...
var tree = {
 ...
 /* 대메뉴 요소 추가 함수 */
 function bigMenuPlus(){
	 var html = `<li>
		 	- <input type="text"/>
		    <ul id="" style="margin-top: 10px;">
 ...
 /* 서브메뉴 요소 추가 함수 */
 function subMenuPlus1(){
	 var html = `<li><span>┖> </span><input type="text"/></li>`;
	 $('#subMenu1').append(html);
 }
 function subMenuPlus2(){
	 var html = `<li><span>┖> </span><input type="text"/></li>`;
	 $('#subMenu2').append(html);
 }
 function subMenuPlus3(){
	 var html = `<li><span>┖> </span><input type="text"/></li>`;
	 $('#subMenu3').append(html);
 }
 
function removeBigMenu(){
	// 1. <ul> element 선택
	  const ul = document
	    .getElementById('treeMenu');
