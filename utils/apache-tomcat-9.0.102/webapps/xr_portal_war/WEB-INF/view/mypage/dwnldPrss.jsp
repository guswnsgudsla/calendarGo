         ...
         <header>
            <div class="inner">
               ...
               <div class="breadcrumbs">
                  ...
                  <span>사용현황</span> 
                  <a href="<c:url value="/mypage/dwnldPrss.do"/>"><span>다운로드 현황</span></a>
               </div>
            </div>
         </header>
            ...
            <div class="inner">
               ...
               <ul class="list-resource">
                  <c:forEach var="item" items="${myDwnldRscList}">
                     <li><a href="<c:url value='/dgtlcltrsc/dgtlCltRscDtl.do?clrcsId=${item.clrcsId}'/>">
                           <div class="img">
                           ...
                           <div class="tag-wrap">
                              <span class="tag size-small color-green">
                                 <c:out value="${item.dataTypeRootCtgryNm}" />
                              </span> 
                           ...
                           <p>
                              <strong><c:out value="${item.clrcsNm}" /></strong>
                           </p>
                     </a>
                        <div class="btn-wrap">
               ...
               <div class="pagination">
                  <c:import url="/WEB-INF/view/include/cmmnPaging.jsp">
                     ...
                     <c:param name="url" value="dwnldPrss.do" />
                  </c:import>
                  <!-- pagination 모바일용 -->
