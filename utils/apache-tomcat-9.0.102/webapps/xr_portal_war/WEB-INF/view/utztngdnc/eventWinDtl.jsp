              ...
              <div class="inner-depth">
                <div class="tab-inner">
                  <div class="event-wrap cont-bg">
                    <div class="view-wrap">
                      <div class="title">
                        <div><c:out value="${view.pstTtl}" /></div>
                        <p>
                          <span><c:out value="${view.frstRegDt}" /></span>
                          <span>작성자 : <c:out value="${pf:getMaskingID(view.frstRgtrId)}" /></span>
                          <span>조회수 : <c:out value="${view.inqCnt}" /></span>
                        </p>
                        <dl>
                          <dt>이벤트 기간</dt>
                          <dd><c:out value="${view.eventPeriod}" /></dd>
                          <dt>당첨자 발표</dt>
                          <dd><c:out value="${view.slctnNtcYmd}" /></dd>
                        </dl>
                      </div>
                      ...
                      <div class="content">
                       <%-- <c:if test="${!empty item.rprsImgFileStrgPathNm or !empty item.rprsImgStrgFileNm } ">
                        ...
                        <div class="cont">
                           <c:set var="pstCn" value="${view.pstCn}" />
